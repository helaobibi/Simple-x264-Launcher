...
protected:
	...
	virtual void runEncodingPass_init(QList<QRegularExpression*> &patterns) = 0;
	virtual void runEncodingPass_parseLine(const QString &line, const QList<QRegularExpression*> &patterns, const ClipInfo &clipInfo, const int &pass, double &last_progress, double &size_estimate) = 0;
