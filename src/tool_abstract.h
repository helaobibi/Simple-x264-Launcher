...
protected:
	...
	virtual void checkVersion_init(QList<QRegularExpression*> &patterns, QStringList &cmdLine) = 0;
	virtual void checkVersion_parseLine(const QString &line, const QList<QRegularExpression*> &patterns, unsigned int &core, unsigned int &build, bool &modified) = 0;
